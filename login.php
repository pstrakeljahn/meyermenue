                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <img style="padding-bottom: 80px; padding-top: 20px" src="img/logo.png" width="350"></img>
                                    <br>
                                    </div>
                                    <form class="user" action="login.php" method="get">
                                    ...
                                    use LoginHelper\UserHelperClass;
                                        if(isset($_GET['ID']) && isset($_GET['pin'])){
                                            ...
                                            $login = new UserHelperClass();
                                            if(!$login->getUser($_GET['ID'], $_GET['pin'])){
                                                echo '<br><center>Eingebene Daten sind falsch!</center>';
                                                } else {
